...
__export(react_exports, {
  SwaggerToolsProvider: () => SwaggerToolsProvider,
  useSwaggerTools: () => useSwaggerTools
});
...
var SwaggerToolsContext = (0, import_react.createContext)({
  tools: [],
  loading: false,
  error: null,
  refetch: async () => {
...
function useSwaggerTools() {
  return (0, import_react.useContext)(SwaggerToolsContext);
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  SwaggerToolsProvider,
  useSwaggerTools
});
